...
def LB_split(lx, ux, ly, uy, tanh=True, split_type=0, n_samples=200):
    ...
    if split_type == 11:
        sel = (X <= 3 / 4 * lx + 1 / 4 * ux) & (Y <= 3 / 4 * ly + 1 / 4 * uy)
    elif split_type == 12:
        sel = (X >= 3 / 4 * lx + 1 / 4 * ux) & (X <= 1 / 2 * lx + 1 / 2 * ux) & (Y <= 3 / 4 * ly + 1 / 4 * uy)
    elif split_type == 13:
        sel = (X >= 1 / 2 * lx + 1 / 2 * ux) & (X <= 1 / 4 * lx + 3 / 4 * ux) & (Y <= 3 / 4 * ly + 1 / 4 * uy)
    elif split_type == 14:
        sel = (X >= 1 / 4 * lx + 3 / 4 * ux) & (Y <= 3 / 4 * ly + 1 / 4 * uy)
    elif split_type == 21:
        sel = (X <= 3 / 4 * lx + 1 / 4 * ux) & (Y >= 3 / 4 * ly + 1 / 4 * uy) & (
                    Y <= 1 / 2 * ly + 1 / 2 * uy)
    elif split_type == 22:
        ...
        sel = (X <= 3 / 4 * lx + 1 / 4 * ux) & (Y >= 1 / 2 * ly + 1 / 2 * uy) & (
                    Y <= 1 / 4 * ly + 3 / 4 * uy)
    elif split_type == 32:
        sel = (X >= 3 / 4 * lx + 1 / 4 * ux) & (X <= 1 / 2 * lx + 1 / 2 * ux) & (Y >= 1 / 2 * ly + 1 / 2 * uy) & (
                    Y <= 1 / 4 * ly + 3 / 4 * uy)
    elif split_type == 33:
        sel = (X >= 1 / 2 * lx + 1 / 2 * ux) & (X <= 1 / 4 * lx + 3 / 4 * ux) & (Y >= 1 / 2 * ly + 1 / 2 * uy) & (
                    Y <= 1 / 4 * ly + 3 / 4 * uy)
    elif split_type == 34:
        sel = (X >= 1 / 4 * lx + 3 / 4 * ux) & (Y >= 1 / 2 * ly + 1 / 2 * uy) & (
                    Y <= 1 / 4 * ly + 3 / 4 * uy)
    elif split_type == 41:
        sel = (X <= 3 / 4 * lx + 1 / 4 * ux) & (Y >= 1 / 4 * ly + 3 / 4 * uy)
    elif split_type == 42:
        sel = (X >= 3 / 4 * lx + 1 / 4 * ux) & (X <= 1 / 2 * lx + 1 / 2 * ux) & (Y >= 1 / 4 * ly + 3 / 4 * uy)
    elif split_type == 43:
        sel = (X >= 1 / 2 * lx + 1 / 2 * ux) & (X <= 1 / 4 * lx + 3 / 4 * ux) & (Y >= 1 / 4 * ly + 3 / 4 * uy)
    elif split_type == 44:
        sel = (X >= 1 / 4 * lx + 3 / 4 * ux) & (X <= 1 / 3 * lx + 2 / 3 * ux) & (Y >= 1 / 4 * ly + 3 / 4 * uy)
    X, Y = X[sel], Y[sel]
    bndX = np.array([lx, lx, ux, ux])
    bndY = np.array([ly, uy, ly, uy])
